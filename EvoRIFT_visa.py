...
def get_logger(name, save_path=None, level='INFO'):
    ...
    if not save_path is None:
        ...
        fileHandler = logging.FileHandler(os.path.join(save_path, 'visa.txt'))
        ...
        if current_epoch % eval_interval == 0 or current_epoch == total_epochs:
            ...
            for item, test_data in zip(item_list, test_data_list):
                ...
                results = evaluation_batch(
                    ...
                    image_score_mode='auto', pixel_refine=args.pixel_refine,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/root/autodl-tmp/VisA_pytorch/1cls')
    ...
    parser.add_argument('--eval_resize_mask', type=int, default=384)
    parser.add_argument('--eval_max_ratio', type=float, default=0.001)
    ...
    parser.add_argument('--p_min', type=float, default=0.7)
    parser.add_argument('--p_max', type=float, default=0.95)
    parser.add_argument('--ssim_weight', type=float, default=0.05)
    parser.add_argument('--regional_focal_weight', type=float, default=0.0)
